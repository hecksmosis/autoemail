    ...
    <div className="min-h-screen bg-black text-white selection:bg-white selection:text-black font-sans flex flex-col">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="p-6 rounded-2xl border border-white/10 bg-white/5 hover:border-white/20 transition-colors">
                ...
                <p className="text-gray-400 text-sm leading-relaxed">
                  24 hours after a visit, we send a fully customisable email
                  asking for feedback. Positive experiences go straight to
                  Google Reviews.
                </p>
              </div>
              ...
              <div className="p-6 rounded-2xl border border-white/10 bg-white/5 hover:border-white/20 transition-colors">
                ...
                <p className="text-gray-400 text-sm leading-relaxed">
                  If a customer hasn't returned in 30 days, we automatically
                  reach out to bring them back to your business with out
                  configurable retention pathways.
                </p>
              </div>
      ...
      <footer className="py-12 border-t border-white/10 bg-black text-gray-500 text-sm">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
          <p>
            © {new Date().getFullYear()} GerpaTech Inc. All rights reserved.
          </p>
